...
- **SQL** (SELECT, JOIN)
- Закрепила и отработала навыки в [Дипломном проекте по тестированию учебного сервиса Яндекс.Самокат](https://docs.google.com/spreadsheets/d/1JEBnTql-wrdsLwdv-JtvKgvaCtuIj_r6k-IuKfaZ4Jo/edit?gid=943703744#gid=943703744). Проект включает чек-листы, тест-кейсы и баг-репорты для веб- и мобильного приложений и API.
